========================================================================
		ActiveX Control DLL : OCXHXEDIT
========================================================================

ControlWizard has created this project for your OCXHXEDIT ActiveX Control
...
that make up your OCXHXEDIT ActiveX Control DLL.
...
OcxHxeditCtl.h
	This file contains the declaration of the COcxHxeditCtrl C++ class.

OcxHxeditCtl.cpp
	This file contains the implementation of the COcxHxeditCtrl C++ class.

OcxHxeditPpg.h
	This file contains the declaration of the COcxHxeditPropPage C++ class.

OcxHxeditPpg.cpp
	This file contains the implementation of the COcxHxeditPropPage C++ class.

OcxHxeditCtl.bmp
	This file contains a bitmap that a container will use to represent the
	COcxHxeditCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ocxHxedit.rc.
